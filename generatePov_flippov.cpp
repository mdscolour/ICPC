...
sprintf(conforname, "chr1/chr1-%s.pov", itarea);
sprintf(finresname, "chr1/chr1-%s.confor", itarea);
...
fprintf(fptr,"camera {\n");
fprintf(fptr,"  location 1.05*<nuscal*%.3f,nuscal*%.3f,-nuscal*%.3f/tan(60*pi/180)> //Camera location\n",
...
fprintf(fptr,"//#end\n");
        ...
        if(stp%2==0){
            ...
            fprintf(fptr,"object{ Nucleo\n");
            fprintf(fptr,"rotate<180,0,0>\n");
            //fprintf(fptr,"scale<1,1,-1>\n");
            fprintf(fptr,"translate<0,0,-2*BR>\n");
            fprintf(fptr,"translate<nuscal*%.3f,0,0>}\n",curpos);
        }
        //cout<<v[stp]<<endl;
